...
export default async function OrderConfirmedPage({
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-24 text-center">
      ...
      <h1 className="mt-6 text-3xl font-semibold tracking-tight text-[var(--label-primary)]">
        {t("confirmedTitle")}
      </h1>
      <p className="mt-3 text-[var(--label-secondary)]">{t("thanks")}</p>

      <div className="mx-auto mt-8 max-w-sm rounded-[var(--radius-card)] border border-[var(--hairline)] bg-[var(--paper)] px-6 py-5 text-left">
